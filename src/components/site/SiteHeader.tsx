      ...
      {open && (
        <div className="fixed inset-0 z-40 bg-fg text-white">
          <div className="flex h-full flex-col justify-end px-8 pb-16 pt-28 lg:px-20">
            <p className="mb-8 font-mono text-[13px] uppercase tracking-wide text-white/40">
              {portfolio.title}
            </p>
            <nav className="flex flex-col gap-3">
              {NAV.map((item, index) => (
                <a
                  ...
                  className="font-medium text-[40px] leading-none tracking-tight text-white lg:text-[48px]"
                >
                  <span className="mr-4 font-mono text-[13px] text-white/40">
            ...
            <a
              ...
              className="mt-12 font-mono text-[13px] uppercase text-white/55 hover:text-white"
            >
              {portfolio.email}
            </a>
          </div>
